...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html" class="fs-5">PanenLokal</a>
            </div>
        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item <?= ($currentPage == 'produk-pertanian')  ?  'active' : '' ?>" >
                        <a href="/produk-pertanian" class="submenu-link">Produk Pertanian</a>
                        
                    </li>         
                    <li class="submenu-item <?= ($currentPage == 'kategori-pertanian')  ?  'active' : '' ?>" >

                        <a href="/kategori-pertanian" class="submenu-link">Kategori Pertanian</a>
            ...
            <!-- <li class="sidebar-title">Blog &amp; Pertanian</li>
